          ...
          <div class="form-block fdgn2 add-patient mt10">
            ...
            <?php if(count($rs_data)>0){?>
              <div class="fieldsets row m-auto bdr border-top-0">
                  ...
                  <div class="col-md-12 bdr border-top-0 text-end mb-1 mt-1 pb-3 ps-5">
                    
                      <button type="button" name="submit" class="btn-main  bg-btn1 btn-blue lnk text-uppercase w-auto AddMemberData ms-2" data-id="<?=$id?>">Add member to your Account <span class="circle"></span></button>
                ...
                <div class="col-md-12 pt-3 pb-3 ps-4 pe-4">
                		<div class="custom-control custom-radio">
												<label class="custom-control-label">
													...
													<span class="ml-3 adri"><span class="fw-semibold"><?=($i+1)?>. <?=$rs_data[$i]['prefix']?> <?=$rs_data[$i]['first_name']?> <?=$rs_data[$i]['last_name']?></span><br><?=$rs_data[$i]['gender']?> , <?=$rs_data[$i]['age']?> yrs.
                          <br>
              ...
              <div class="fieldsets row m-auto pt-3 pb-3">
                    ...
                    <button type="button" name="submit" class="btn-main bg-btn1 btn-blue lnk bg-success add-totest text-uppercase w-100 selectMemberData">Add to Test <span class="circle"></span></button>
