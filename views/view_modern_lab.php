...
<!--End Header -->
<!--Start Hero-->
<section class="hero-card-web bg-gradient12 shape-bg3 h-auto bannir">
 <div class="hero-main-rp container-fluid">
    <div class="row align-items-center">
       <div class="col-lg-5">
          <div class="hero-heading-sec">
             <h1  class="wow fadeIn text-white f-bold" data-wow-delay="0.3s">Lab Test From The Comfort Of Your Home </h1>
                <p class="wow fadeIn mt30" data-wow-delay="0.6s">Get the assurance of Accurate blood test services from MDC. MODERN has NABL as well as NABH Accreditations.</p>
                ...
                <div class="owl-carousel service-card-prb">
                      ...
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-1.jpg">
                            </div>
                            <div class="title-serv-c">Molecular Diagnostics & Oncogenomics</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-2.jpg">
                            </div>
                            <div class="title-serv-c">Cytogenetics</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-3.jpg">
                            </div>
                            <div class="title-serv-c">Histopathology & Cytopathology</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-4.jpg">
                            </div>
                            <div class="title-serv-c">Microbiology</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-5.jpg">
                            </div>
                            <div class="title-serv-c">Hematology And Coagulation</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-6.jpg">
                            </div>
                            <div class="title-serv-c">Biochemistry</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-7.jpg">
                            </div>
                            <div class="title-serv-c">Allergy Testing</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-8.jpg">
                            </div>
                            <div class="title-serv-c">Serology and Immunology</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-9.jpg">
                            </div>
                            <div class="title-serv-c">Hormonal Assays</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-10.jpg">
                            </div>
                            <div class="title-serv-c">Cervical Cancer Screening</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-f" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-11.jpg">
                            </div>
                            <div class="title-serv-c">Maternal Screening Markers</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-12.jpg">
                            </div>
                            <div class="title-serv-c">Clinical Pathology</div>
                         </div>
                      </a>
                   </div>
                   <div class="service-slide card-bg-a" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                      <a class="scrollTo" href="#servicesGrids">
                         <div class="service-card-hh">
                            <div class="image-sr-mm">
                               <img alt="custom-sport" src="images/modern-13.jpg">
                            </div>
                            <div class="title-serv-c">Autoimmune Profile</div>
                         </div>
                      </a>
                   </div>
                </div>
   ...
   <div class="container">
      <div class="row">
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.2s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="service-details"><img src="images/modern-1.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
                      <h4><a href="#">Molecular Diagnostics & Oncogenomics</a></h4>
                  </div>
              </div>
          </div>
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.4s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-2.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
                      <h4><a href="#">Cytogenetics</a></h4>
                  </div>
              </div>
          </div>
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-3.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
                      <h4><a href="#">Histopathology & Cytopathology</a></h4>
                  </div>
              </div>
          </div>
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-4.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
          ...
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-5.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
                      <h4><a href="#">Hematology And Coagulation</a></h4>
                  </div>
              </div>
          </div>
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-6.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
          ...
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-7.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
          ...
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-8.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
                      <h4><a href="#">Serology and Immunology</a></h4>
                  </div>
              </div>
          </div>
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-9.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
                      <h4><a href="#">Hormonal Assays</a></h4>
                  </div>
              </div>
          </div>
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-10.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
                      <h4><a href="#">Cervical Cancer Screening</a></h4>
                  </div>
              </div>
          </div>
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-11.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
                      <h4><a href="#">Maternal Screening Markers</a></h4>
                  </div>
              </div>
          </div>
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-12.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
                      <h4><a href="#">Clinical Pathology</a></h4>
                  </div>
              </div>
          </div>
          <div class="col-lg-4 col-sm-4 mt40 wow fadeIn" data-wow-delay="0.6s">
              <div class="isotope_item up-hor">
                  <div class="item-image">
                      <a href="#"><img src="images/modern-13.jpg" alt="image" class="img-fluid" /> </a>
                  </div>
                  <div class="item-info-div shdo">
                      <h4><a href="#">Autoimmune Profile</a></h4>
                  </div>
              </div>
          </div>
      </div>
