    ...
    <div class="row align-items-center">
      <div class="col-lg-5 col-md-6 col-12">
        <div class="common-heading-1 text-l text-center text-lg-start text-md-start">
          ...
          <p class="text-white">MDC is one of the few Diagnostic Companies in Nepal which offers more than 2500 tests, ranging from Molecular to Whole Body Imaging. </p><br />
          
<p class="text-white">MODERN is accredited with CAP, NABL & NABH which strengthens our commitment to Quality and Accuracy in our reports.  </p><br />
        ...
        <div class="form-block formcover shadow">
          <form method="post" id="prescription_booking" name="prescription_booking" class="shake mt30">
            <div class="row">
              ...
              <div class="form-group col-sm-6">
                <input type="text" id="email" name="email" placeholder="Email*" value="<?=$this->rs_customer['email']?>" required="">
                <div class="help-block with-errors"></div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="form-group col-sm-6">
                <input type="text" id="age" placeholder="Age"  class="numbersOnly" name="age" required="">
                <div class="help-block with-errors"></div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-sm-3">
                <label class="text-dark ms-0 me-2 mt-2"><input type="radio" value="Male" id="gender_male" name="gender"> Male</label>
                <label class="text-dark"><input type="radio" value="Female" id="gender_female" name="gender"> Female</label>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-sm-6">
                <textarea rows="5" placeholder="Address" id="address" name="address" required=""></textarea>
                <div class="help-block with-errors"></div>
              </div>
              <div class="form-group col-sm-6">
                <textarea rows="5" placeholder="Brief details of your illness"  id="brief_details" name="brief_details" required=""></textarea>
                <div class="help-block with-errors"></div>
              </div>
            </div>
            ...
            <button type="submit" class=" mt-2 lnk btn-main bg-btn prescription_booking_btn">Submit <i class="fas fa-chevron-right fa-icon"></i></button>
              ...
              <div class="row">
                ...
                <div class="col-lg-9 common-heading-2 text-start col-xs-12 col-12">
                  ...
                  <ul class="list-style- text-202024">
                    ...
                    <li>Meet required standards from CLIA, FDA and OSHA. CAP requirements commonly exceed the standards, bolstering patient care and safety.</li>
