...
<section class="shop-products-bhv booking-info pt40 pb60">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 mb-4">
                <h4 class="failDiv rounded"><img src="images/icon-fail.png" alt="" /> Your Booking payment is failed!</h4>
            </div>
        </div>
 ...
 <a href="my-orders" class="btn-main bg-btn checkout-btn lnk w-100 mb-1">My Orders <i class="fas fa-chevron-right fa-icon fa-ani"></i></a>
