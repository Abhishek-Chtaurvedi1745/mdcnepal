	...
	<div class="text-block">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6">
					<h2 class="wow fadeInUp fs-3 f-bold text-white" data-wow-delay=".2s">MODERN Full Body Checkup</h2>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row align-items-end section-title">
			...
			<div class="col-lg-12 col-md-12 col-12 mb-2">
				<div class="common-heading-2 text-start">
					<h1 class="mb20 main-heading-1"><?= $page_title; ?></h1>
			...
			<div class="row" id="results">
				...
				<div class="row">
					...
					<div class="col-lg-12 " style="text-align:center">
						<button class="btn-main bg-btn1 btn-blue text-white lnk wow fadeInUp animation_image" id="l_more" align="center" style="display:none">Load More</button>
					</div>
					<?= $page_desc ?>
				</div>
...
<!--End Faqs-->
<section class=" pt60 testimonials  testimonial-bg pb20 raiolog">
    <div class="container">
