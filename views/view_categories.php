	...
	<div class="container">
		...
		<div class="row upset link-hover shape-num justify-content-start">
			<?php
				...
				$image = $this->utility->get_image_path($item['image'], 'item_category', 'large');
			?>
			<div class="col-lg-3 col-md-4 col-6  mt30 shape-loc  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
				<div class="s-block" data-tilt="" data-tilt-max="5" data-tilt-speed="1000" style="will-change: transform; transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);">
					...
					<h4><?=$item['name'];?></h4>
					<a href="category/<?= $_SESSION['citySlug']; ?>/<?= $item['slug']; ?>">BOOK NOW<i class="fas fa-chevron-right fa-icon"></i></a>
				</div>
			</div>
			<?php $j++;
				}
				...
				<div class="row section-title text-center">
					<div class="col-sm-12 col-12">
						<div class="common-heading-2 ">
							<h3 class="fs-3 text-202024">Schedule your Categories Test with MDC</h3>
							<h5 class="mb20">Take control of your Categories journey
								book your comprehensive Categories test with MDC now</h5>
						</div>
					</div>
				</div>
			</div>
