        ...
        <div>
          ...
          <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              ...
              <li class="breadcrumb-item"><a href="javascript:void(0)">Mannage Item</a></li>
          ...
          <h3 class="mg-b-0 tx-spacing--1">Items</h3>

        </div>

        <div class="">
          <a href="index.php?view=data_import" class="btn btn-sm pd-x-15 btn-success  btn-uppercase mg-l-5 d-none" data-id=""><i data-feather="upload" class="wd-10 mg-r-5" ></i>Import</a>
          <a href="index.php?view=item_list&act=export_data" class="btn btn-sm pd-x-15 btn-warning btn-uppercase mg-l-5" data-id=""><i data-feather="download" class="wd-10 mg-r-5" ></i> Export To Excel</a>

          <a href="index.php?view=item_addedit" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 item_addedit_onclick_rr" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</a>

          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_item_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
...
-->     
 ...
 <div data-label="All item" class="df-example demo-table">
...
<script src="scripts/js/item.js?v=1.1"></script> 
