        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Manaage Website</a></li>
              <li class="breadcrumb-item active" aria-current="page">Testimonial</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Testimonial</h3>
        </div>
        <div class="">
          <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 testimonial_addedit_onclick" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</button>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_testimonial_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
     <!-- <p class="mg-b-30">Sytem accept only order of below Testimonial.</p>-->
      <div data-label="All Testimonial" class="df-example demo-table">
        <table id="table_testimonial" class="table">
          <thead>
            <tr>
...
<script src="scripts/js/testimonial.js?v=1.1"></script> 
