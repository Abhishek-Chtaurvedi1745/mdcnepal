        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Mannage Events</a></li>
              <li class="breadcrumb-item active" aria-current="page">Events</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Events</h3>
        </div>
        <div class="">
          <a href="index.php?view=event_addedit" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 event_addedit_onclick_rr" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</a>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_event_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
...
-->     
 ...
 <div data-label="All event" class="df-example demo-table">
