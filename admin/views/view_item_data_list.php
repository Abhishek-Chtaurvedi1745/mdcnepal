    ...
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          ...
          <h3 class="mg-b-0 tx-spacing--1">Package - <?=$this->rs_data['name']?></h3>
        </div>
        <div class="">
...
<div class="df-example datatable-menu-tab">
		  ...
		  ?>
            ...
            <li class="nav-item" >
              <a class="nav-link   <?=$all?> "  href="index.php?view=item_data_list&data_id=<?=$this->rs_data['id']?>&tab_type=All" >All</a>
            </li>
            <li class="nav-item">
              <a class="nav-link   <?=$Selected?>" href="index.php?view=item_data_list&data_id=<?=$this->rs_data['id']?>&tab_type=Selected" >Selected Test</a>
            </li>
 ...
 <input type="hidden" name="data_id" id="data_id" value="<?=$this->rs_data['id']?>">
...
<script src="scripts/js/item_data.js"></script> 
