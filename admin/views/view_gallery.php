    ...
    <div class="container">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        ...
        <div>
          ...
          <h3 class="mg-b-0 tx-spacing--1">Images Upload - <span style="font-size:16px"><?=$this->rs_product['name']?></span></h3>
      ...
      <div data-label="Multi Images Upload" class="df-example demo-table">
        ...
        <div class="block">
          ...
          <form class="dropzone" id="my_awesome_dropzone" enctype="multipart/form-data">
            ...
            <input type="hidden" name="cat_id" id="cat_id" value="<?=$this->getGetVar("cat_id")?>"/>

            <input type="hidden" name="folder" id="folder" value="gallery"/>
          ...
          <div class="form-bordered" style="clear:both;    margin-top: 20px;">
            ...
            <div class="form-group form-actions">
              ...
              <a href="index.php?view=gallery&cat_id=<?=$this->getGetVar("cat_id")?>" class="btn btn-effect-ripple btn-danger">Reset</a> </div>
      ...
      <div data-label="Gallery Images" class="df-example demo-table">
        ...
        <div class="d-none d-md-block text-right pb-2">
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_gallery_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>

        <table id="table_gallery" class="table">
...
<script src="scripts/js/gallery_images.js"></script> 
...
$(function() {
      ...
      var folder=$("#folder").val();
        ...
        var myDropzone = new Dropzone("#my_awesome_dropzone",{
            ...
            url: "scripts/ajax/index.php?method=images_uploads&cat_id="+cat_id+"&folder="+folder+"",
