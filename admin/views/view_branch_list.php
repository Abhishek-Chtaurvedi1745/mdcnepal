        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Mannage Website</a></li>
              <li class="breadcrumb-item active" aria-current="page">Branch</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Branch</h3>
        </div>
        <div class="">
          <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 branch_addedit_onclick" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</button>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_branch_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
<!--      <p class="mg-b-30">Sytem accept only order of below Manufacturer.</p>
-->      <div data-label="All branch" class="df-example demo-table">
        <table id="table_branch" class="table">
          <thead>
            <tr>
...
<script src="scripts/js/branch.js"></script> 
