  ...
  <div class="content-body">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Mannage Blog</a></li>
        ...
        <div class="">
          <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 blog_category_addedit_onclick" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</button>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_blog_category_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
<!--      <p class="mg-b-30">Sytem accept only order of below Manufacturer.</p>
-->      <div data-label="All Blog Category" class="df-example demo-table">
...
<script src="scripts/js/blog_category.js"></script> 
