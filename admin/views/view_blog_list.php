    ...
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          ...
          <h3 class="mg-b-0 tx-spacing--1">blog</h3>
        </div>
        <div class="">
          <a href="index.php?view=blog_addedit" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 blog_addedit_onclick_rr" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</a>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_blog_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
...
-->     
 ...
 <div data-label="All blog" class="df-example demo-table">
