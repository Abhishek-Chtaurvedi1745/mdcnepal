...
$(document).ready(function(){
	...
	$('#table_item').DataTable({
		...
		'serverMethod': 'post',
		'ajax': {
			'url':'scripts/ajax/index.php?method=item_data&actionType=item_list&data_id='+data_id+'&tab_type='+tab_type,
		},
		'columns': [
		 	{ "data": "checkbox" },
		  	{ "data": "id" },
						...
						if(r == true)
						  {
							  ...
							  dataType: 'json',
							  url: "scripts/ajax/index.php",
							  data: "method=item_data&actionType=itemMultiDelete&ids="+ids+"&data_ids"+data_ids,
							  success: function(responseData){
								  if(responseData.RESULT==0)
								  {
						...
						if(r == true)
						  {
							  ...
							  dataType: 'json',
							  url: "scripts/ajax/index.php",
							  data: "method=item_data&actionType=itemMultiAdd&ids="+ids+"&data_ids="+data_ids,
							  success: function(responseData){
								  if(responseData.RESULT==0)
								  {
									  $.bootstrapGrowl('<h4><strong>Notification</strong></h4> <p>'+responseData.msg+'</p>', {type:'success',delay: 3000,allow_dismiss: true,offset: {from: 'top', amount: 20}});
