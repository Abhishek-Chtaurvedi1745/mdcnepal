			...
			success: function(data){
				...
				var html_table_row='<tr height="40" class="a_rows" id="prorow_'+row_id+'">';
				 html_table_row+='<td align="center" valign="middle" class="pro_img"><img src="'+data.IMAGE+'" class="row_product_img"></td>';
                    ...
                    html_table_row+='<td align="center" valign="middle" class="pro_weight"><input type="text" class="form-control numbers" value="'+data.product_unit_weight+'" id="weight_'+row_id+'" name="weight[]" onkeypress="get_hide('+row_id+');"/></td>';
					...
					// html_table_row+='<td align="center" valign="middle" class="pro_unit_price"><span class="populated">'+data.product_cost+'</span></td>';
					 ...
					 html_table_row+='<td align="center" valign="middle" class="pro_unit_price1"><input type="text" class="form-control numbers" value="'+data.product_cost+'" id="prices_'+row_id+'" name="prices[]" /></td>';
                    ...
                    html_table_row+='<td align="center" ><input type="hidden" class="populated" value="'+data.product_id+'" id="product_ids_'+row_id+'" name="product_ids[]" /><input type="hidden" class="populated" value="'+data.product_mrp+'" id="p_mrp_'+row_id+'" name="p_mrp[]"><input type="hidden" class="populated" value="" id="od_ids_'+row_id+'" name="od_ids[]"><strong><a href="javascript:onclick=delete_row('+row_id+')";"  class="remove_row" id="delete_'+row_id+'"><i class="fa fa-trash" style=""></i></strong></td>';
                    html_table_row+='</tr>';
	...
	function get_hide(row_id)
{
	...
	function get_price111111(row_id,product_id)
	...
	function get_price(row_id,product_id)
	{
		...
		var new_price=$("#prices_"+row_id).val();
...

		{
			...
			data: "method=update_order_price1&product_id="+product_id+"&weight="+in_weight+"&qty="+in_qty+"&new_price="+new_price,
