...
$(document).ready(function(){
	$('#table_career').DataTable({
		...
		'serverMethod': 'post',
		'ajax': {
			'url':'scripts/ajax/index.php?method=career&actionType=career_list',
		},
		'columns': [
		  	{ "data": "id" },
		    { "data": "image" },
...
<!-- End: Active brand List -->


<!-- Start: brand single delete  -->
$(document).on("click",".career_delete_onclick", function ()
{
            ...
            }, function (r)
			{
				if(r == true)
				{
					$.ajax(
					{
						  ...
						  data: "method=career&actionType=careerDelete&getid="+getid,
						  success: function(responseData)
						  {
								  if(responseData.RESULT==0)
								  {
									var oTable = $('#table_career').dataTable( );
...
<!-- End: brand single delete  -->

<!-- Start: brand Multi delete  -->
function mulitple_career_select()
{
			var chk_vals=[];
						...
						if(r == true)
						  {
							  ...
							  dataType: 'json',
							  url: "scripts/ajax/index.php",
							  data: "method=career&actionType=careerMultiDelete&ids="+ids,
							  success: function(responseData){
								  if(responseData.RESULT==0)
								  {
