      ...
      <form method="post" name="banner_form" id="banner_form"  data-parsley-validate>
        ...
        <div class="modal-body">
          ...
          <div class="form-group col-md-12">
              ...
              <? $app->htmlBuilder->buildTag("select", array("class"=>"form-control","selected"=>$show_page, "values"=>array("home"=>"home","radiology"=>"radiology","pathology"=>"pathology","premium"=>"premium","diseases"=>"diseases","category"=>"category","radiology_item"=>"Radiology Item Detail","pathology_item"=>"Pathology Item Detail"),"required"=>""), "show_page") ;?>
            </div>
