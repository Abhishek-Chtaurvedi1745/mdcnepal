<?
		function custom_error($error_level, $error_message, $error_file, $error_line, $error_context = array()){
			global $app;
			if(defined("ERROR_LOG") && ERROR_LOG != ""){
				@error_log("[".date("Y-m-d H:i:s")."] ".$error_message." in ".$error_file." on line ".$error_line."\n", 3, ERROR_LOG);
			}
			if(DEBUG==1){
