...
class _home extends controller{
	...
	function onload()
	{
		if("https://".$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI]==SERVER_ROOT.'/index.php/about-us' || "https://".$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI]==SERVER_ROOT.'/index.php/about-us/')
		{
