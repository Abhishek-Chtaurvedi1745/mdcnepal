<?php
	class model_banner{
		...
		function model_banner($ID=0){
			...
			$this->fields["show_page"]="enum('home','radiology','pathology','premium','diseases','category','radiology_item','pathology_item')";
			$this->nullable["show_page"]="NO";
			$this->default_value["show_page"]="home";
		}
	}
?>